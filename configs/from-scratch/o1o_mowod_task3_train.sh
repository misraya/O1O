...
WANDB_NAME=o1o_mowod_task3_train
DATA_DIR='data/OWOD'
...
python -u main_open_world_o1o.py \
    ...
    --batch_size 6 --eval_every 1 --lr 0.00002 --epochs 70 \
    ...
    --resume "./exps/o1o_mowod_task2_ft/checkpoint0059.pth" \
    --exemplar_replay_selection --exemplar_replay_dir ${EXEMPLAR_REPLAY_DIR}  --exemplar_replay_max_length 2361\
