...
WANDB_NAME=o1o_sowod_task4_train
DATA_DIR='data/OWOD'
...
python -u main_open_world_o1o.py \
    ...
    --batch_size 6 --eval_every 1 --lr 0.00002 --epochs 90 \
    ...
    --resume "./exps/o1o_sowod_task3_ft/checkpoint0079.pth" \
    --exemplar_replay_selection --exemplar_replay_dir ${EXEMPLAR_REPLAY_DIR}  --exemplar_replay_max_length 2664\
